/* */ 
"format cjs";
define(["doh", "dojo", "require", "./modules/anon", "./modules/wrapped", "dojo/tests/_base/loader/modules/full", "./modules/data", "./modules/factoryArity", "./modules/factoryArityExports", "./modules/idFactoryArity", "./modules/idFactoryArityExports"], function(doh, dojo, require, anon, wrapped) {
  doh.register("dojo.tests._base._loader.modules", [function testAMD(t) {
